...
class Complete extends AbstractSoapClientBase
{
     ...
     * @param \StructType\CompleteSaleRequestType $completeSaleRequest
     * @return \StructType\CompleteSaleResponseType|bool
     */
    public function CompleteSale(\StructType\CompleteSaleRequestType $completeSaleRequest)
    {
        try {
