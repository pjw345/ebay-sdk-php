...
class Send extends AbstractSoapClientBase
{
     ...
     * @param \StructType\SendInvoiceRequestType $sendInvoiceRequest
     * @return \StructType\SendInvoiceResponseType|bool
     */
    public function SendInvoice(\StructType\SendInvoiceRequestType $sendInvoiceRequest)
    {
        try {
