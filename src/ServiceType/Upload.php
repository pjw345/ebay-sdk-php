...
class Upload extends AbstractSoapClientBase
{
     ...
     * @param \StructType\UploadSiteHostedPicturesRequestType $uploadSiteHostedPicturesRequest
     * @return \StructType\UploadSiteHostedPicturesResponseType|bool
     */
    public function UploadSiteHostedPictures(\StructType\UploadSiteHostedPicturesRequestType $uploadSiteHostedPicturesRequest)
    {
        try {
