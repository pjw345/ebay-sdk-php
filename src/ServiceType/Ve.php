...
/**
 * This class stands for Ve ServiceType
 * @subpackage Services
 */
class Ve extends AbstractSoapClientBase
{
    /**
     ...
     * @param \StructType\VeROReportItemsRequestType $veROReportItemsRequest
     * @return \StructType\VeROReportItemsResponseType|bool
     */
    public function VeROReportItems(\StructType\VeROReportItemsRequestType $veROReportItemsRequest)
    {
        try {
