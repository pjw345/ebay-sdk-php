...
class Save extends AbstractSoapClientBase
{
     ...
     * @param \StructType\SaveItemToSellingManagerTemplateRequestType $saveItemToSellingManagerTemplateRequest
     * @return \StructType\SaveItemToSellingManagerTemplateResponseType|bool
     */
    public function SaveItemToSellingManagerTemplate(\StructType\SaveItemToSellingManagerTemplateRequestType $saveItemToSellingManagerTemplateRequest)
    {
        try {
