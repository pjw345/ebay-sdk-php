...
class Confirm extends AbstractSoapClientBase
{
     ...
     * @param \StructType\ConfirmIdentityRequestType $confirmIdentityRequest
     * @return \StructType\ConfirmIdentityResponseType|bool
     */
    public function ConfirmIdentity(\StructType\ConfirmIdentityRequestType $confirmIdentityRequest)
    {
        try {
