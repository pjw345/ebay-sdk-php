...
/**
 * This class stands for InternationalReturnsShipmentPayeeDefinitionType StructType
 ...
 * valid in AddItem and its related family of calls, and in the return policies you configure for use with the Account API.
 * @subpackage Structs
 */
class InternationalReturnsShipmentPayeeDefinitionType extends AbstractStructBase
{
    /**
     * The any
     * @var \DOMDocument
    ...
    public $any;
    /**
     * Constructor method for InternationalReturnsShipmentPayeeDefinitionType
     * @uses InternationalReturnsShipmentPayeeDefinitionType::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument $any
     * @return \StructType\InternationalReturnsShipmentPayeeDefinitionType
     */
