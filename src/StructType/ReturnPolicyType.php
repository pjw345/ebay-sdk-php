...
class ReturnPolicyType extends AbstractStructBase
{
     ...
     * The RefundOption
     * Meta information extracted from the WSDL
     * - documentation: This field indicates how the seller compensates buyers for <a href="http://developer.ebay.com/DevZone/guides/features-guide/default.html#development/Post-Order-Returns.html#return-reasons" target="_blank">returns</a>. You must set
     * this value to <code>MoneyBack</code> for all eBay marketplaces except for the US marketplace. <br><br> On <code>EBAY_US</code>: You can set this value to either <code>MoneyBack</code> or <code>MoneyBackOrReplacement</code>. If a seller has the depth
     * of inventory to support an exchange for an identical item, you can set <code>MoneyBackOrReplacement</code>. Otherwise, set this value to <code>MoneyBack</code>. <br><br> <b>For ReviseItem only:</b> You cannot change the value of this field if the
     * listing has bids or sales, or if the listing ends within 12 hours. For more details, see the <b>ReturnPolicy</b> description.
     * - minOccurs: 0
     * @var string
     */
    public $RefundOption;
     ...
     * <b>GetCategoryFeatures</b> call now returns category-level metadata for both domestic and international return policies, and developers should make plans to use that call for this metadata.</span>
     * - minOccurs: 0
     * @var string
     */
