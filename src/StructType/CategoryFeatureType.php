...
class CategoryFeatureType extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - documentation: This field indicates if the category supports Product-Based Shopping Experience listings (listings associated with eBay catalog products). PBSE is currently supported by the US, UK, Germany, Australia, and Canada (English) sites.
     * <br><br> Only returned when this value (or this category's setting) overrides the value inherited from the category's parent or the site default. Will not be returned if one or more <a href="types/FeatureIDCodeType.html">FeatureID</a> values are used
     * in the call request, and one of those values does not include <code>ProductRequiredEnabled</code>. <br><br> <span class="tablenote"><b>Note:</b> Due to the rollback of the Product-Based Shopping Experience mandate for all eBay categories, the value
     * for this field should never get returned as <code>Enabled</code> for any production categories.</span>
     * - minOccurs: 0
     * @var string
     */
