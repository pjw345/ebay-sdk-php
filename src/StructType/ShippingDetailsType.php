...
class ShippingDetailsType extends AbstractStructBase
{
     ...
     * The SalesTax
     * Meta information extracted from the WSDL
     * - documentation: This container shows the sales tax rate percentage for a specific tax jurisdiction. Additionally, it indicates whether or not the seller applies sales tax to shipping charges in addition to the item cost. The concept of 'sales tax'
