...
/**
 * This class stands for InternationalReturnsDurationDefinitionType StructType
 ...
 * and its related family of calls, and in the return policies you configure for use with the Account API.
 * @subpackage Structs
 */
class InternationalReturnsDurationDefinitionType extends AbstractStructBase
{
    /**
     * The any
     * @var \DOMDocument
    ...
    public $any;
    /**
     * Constructor method for InternationalReturnsDurationDefinitionType
     * @uses InternationalReturnsDurationDefinitionType::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument $any
     * @return \StructType\InternationalReturnsDurationDefinitionType
     */
